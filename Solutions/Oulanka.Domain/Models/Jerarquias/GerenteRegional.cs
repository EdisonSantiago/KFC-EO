...
{
    public class GerenteRegional : EntityWithTypedId<Guid>
    {
        ...
        public virtual GerenteNacional GerenteNacional { get; set; }

        [ScriptIgnore]
        public virtual IList<JefeArea> JefesAreas { get; set; }
    }
}