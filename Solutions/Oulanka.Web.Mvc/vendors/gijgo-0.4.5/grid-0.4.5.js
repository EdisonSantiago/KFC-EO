...
gj.grid.configuration = {
    base: {
        ...
        columns: [
            {
                ...
                /** Configuration object with event names as keys and functions as values that are going to be bind to each cell from the column.
                  ...
                  *               events: { 
                  *                 "click": function (e) { 
                  *                     alert("record with id=" + e.data.ticketId + " is clicked."); } 
                  *                 }
                  *             }
                  *         ]
                  *     });
        ...
        pager: {
            ...
            /** Array that contains a list with jquery objects that are going to be used on the left side of the pager.
                ...
                */
            leftControls: [
                $('<div title="Primero" data-role="page-first" class="ui-icon ui-icon-seek-first ui-grid-icon"></div>'),
                ...
                $('<div title="Último" data-role="page-last" class="ui-icon ui-icon-seek-end ui-grid-icon"></div>'),
                $('<div title="Refrescar" data-role="page-refresh" class="ui-icon ui-icon-refresh ui-grid-icon"></div>'),
    ...
    bootstrap: {
        ...
        pager: {
            leftControls: [
                $('<button type="button" data-role="page-first" title="Primera Página" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-step-backward"></span></button>'),
                $('<div>&nbsp;</div>'),
                $('<button type="button" data-role="page-previous" title="Página Anterior" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-backward"></span></button>'),
                $('<div>&nbsp;</div>'),
                $('<div>Página</div>'),
                $('<div>&nbsp;</div>'),
                ...
                $('<div data-role="page-label-last">0</div>'),
                $('<div>&nbsp;</div>'),
                $('<button type="button" data-role="page-next" title="Siguiente Página" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-forward"></span></button>'),
                $('<div>&nbsp;</div>'),
                $('<button type="button" data-role="page-last" title="Última Página" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-step-forward"></span></button>'),
                $('<div>&nbsp;</div>'),
                $('<button type="button" data-role="page-refresh" title="Refrescar" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-refresh"></span></button>'),
                $('<div>&nbsp;</div>'),
...
﻿gj.grid.events = {
    ...
    rowDataBound: function ($grid, $row, id, record) {
         ...
         * @property {object} id - the ticketId of the record
         ...
         *         alert("rowDataBound is fired for row with id=" + ticketId + ".");
         *     });
         * </script>
         */
    ...
    cellDataBound: function ($grid, $wrapper, id, index, record) {
         ...
         * @property {string} id - the ticketId of the record
    ...
    rowSelect: function ($grid, $row, id, record) {
         ...
         *         alert('Row with id=' + ticketId + ' is selected.');
         *     });
         * </script>
         */
    ...
    rowUnselect: function ($grid, $row, id, record) {
         ...
         *         alert('Row with id=' + ticketId + ' is unselected.');
         *     });
         * </script>
         */
...
gj.grid.public = {
     ...
     * @method
     * @memberof Grid
     * @param {string} id - The ticketId of the row that needs to be selected
     * @return void
     ...
     * @method
     * @memberof Grid
     * @param {string} id - The ticketId of the row that needs to be returned.
     * @return object
     ...
     *             names += this.record.Name + "(id=" + this.ticketId + "),";
     *         });
     *         alert(names);
     *     });
     * </script>
     ...
     * @method
     * @memberof Grid
     * @param {string} id - The ticketId of the row that needs to be updated
     * @param {object} record - Object with data for the new record.
     * @return grid
     * @example <table id="grid"></table>
     * <script>
     *     var grid, data;
     *     function Edit(e) {
     *         grid.updateRow(e.data.id, { "ID": e.data.ticketId, "Name": "Ronaldo", "PlaceOfBirth": "Rio, Brazil" });
     *     }
     *     grid = $("#grid").grid({
     *         dataSource: [
     *             { "ID": 1, "Name": "Hristo Stoichkov", "PlaceOfBirth": "Plovdiv, Bulgaria" },
