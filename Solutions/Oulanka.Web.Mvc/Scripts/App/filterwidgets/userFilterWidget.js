...
function UserFilterWidget() {
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="form-group">\
                    ...
                    <select style="width:250px;" class="grid-filter-type userlist form-control">\
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("/utils/getusers", function (data) {
    ...
    */
    this.fillStatus = function (items) {
        var customerList = this.container.find(".userlist");
