...
function OperatorFilterWidget() {
    ...
    */
    this.getAssociatedTypes = function () {
        return ["HelpDeskOperatorFilterWidget"];
    };
    /***
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="form-group">\
                    ...
                    <select style="width:250px;" class="grid-filter-type operatorlist form-control">\
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("/utils/getoperators", function (data) {
    ...
    */
    this.fillStatus = function (items) {
        var customerList = this.container.find(".operatorlist");
