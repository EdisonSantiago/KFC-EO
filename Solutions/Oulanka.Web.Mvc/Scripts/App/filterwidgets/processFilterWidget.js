...
function ProcessFilterWidget() {
    ...
    */
    ...
    this.renderWidget = function () {
        var html = '<div class="form-group">\
                    ...
                    <select style="width:250px;" class="grid-filter-type processlist form-control">\
    ...
    */
    this.loadCustomers = function () {
        var $this = this;
        $.post("/utils/getprocesses", function (data) {
    ...
    */
    this.fillStatus = function (items) {
        var customerList = this.container.find(".processlist");
