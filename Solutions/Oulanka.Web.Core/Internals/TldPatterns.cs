...
namespace Oulanka.Web.Core.Internals
{
    /**
    ...
    public class TldPatterns
    {
      ...
      "edu.ws"
        ...
        /**
         * If a hostname is not in the EXCLUDE set, and if removin its
         * leftmost component results in a name with is contained in this
         * set, it is a TLD
         */
